...
RAW_LOG_SOURCE="local"
RAW_LOG_USER=""
RAW_LOG_HOST=""
ELKTAIL_PATH="./elktail"
ELASTICSEARCH_PROTO="http"
ELASTICSEARCH_HOST="192.168.99.101"
ELASTICSEARCH_PORT="9200"
SORT_FIELD="kafka.offset"
LOG_FIELD="data"
MAX_LOGS="10000"
LOG_INDEX_DATE="$1"
LOG_FILTER_1="$2"
LOG_FILTER_2="_ordCreLog"
RAW_LOG_PATH="$3"
PERSIST_LOGS="$4"
...
if [ "x$RAW_LOG_SOURCE" == "xremote" ];then
	...
	ssh $RAW_LOG_USER@$RAW_LOG_HOST cat $RAW_LOG_PATH | grep "$LOG_FILTER_1" > ${LOG_FILTER_1}_source_processed.log
else
...
echo "checking from Elasticsearch"
